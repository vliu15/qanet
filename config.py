...
token_weights_file = os.path.join(target_dir, "token_embeddings.hdf5") # for ELMo only
...
flags.DEFINE_integer("elmo_dim", 1024, "Embedding dimension for ELMo")

flags.DEFINE_integer("para_limit", 400, "Limit length for paragraph")
flags.DEFINE_integer("ques_limit", 50, "Limit length for question")
flags.DEFINE_integer("ans_limit", 30, "Limit length for answers")
flags.DEFINE_integer("test_para_limit", 500, "Limit length for paragraph in test file")
flags.DEFINE_integer("test_ques_limit", 50, "Limit length for question in test file")
flags.DEFINE_integer("char_limit", 16, "Limit length for character")
flags.DEFINE_integer("cont_char_limit", 50, "Limit length for character for context")
...
elmo_weights_file = os.path.join(home, "datasets", "elmo", "weights.hdf5")
elmo_options_file = os.path.join(home, "datasets", "elmo", "options.json")
elmo_vocab_file = os.path.join(home, "datasets", "elmo", "vocab-2016-09-10.txt")
flags.DEFINE_string("elmo_weights_file", elmo_weights_file, "Weights file for ELMo")
flags.DEFINE_string("elmo_options_file", elmo_options_file, "Options file for ELMo")
flags.DEFINE_string("elmo_vocab_file", elmo_vocab_file, "Vocab file for ELMo")
